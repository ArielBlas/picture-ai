...
export const ImageGenerationformSchema = z.object({
  ...
  num_outputs: z
    ...
    .max(4, {
      message: "Number of outputs must be less then 4.",
    }),
  ...
  output_quality: z
    ...
    .max(100, {
      message: "Output quality must be less then or equal to 100.",
    }),
                  ...
                  <FormLabel className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Number of denoising steps. Recomended range is 28-50
                            for dev model and 1-4 for schnell mode
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            ...
                            100 is best quaility, 0 is lowest quality.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
